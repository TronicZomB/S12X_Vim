...
syn match sxPEMicro '[#$%]\(EJECT\|HEADER\|NOLIST\|LIST\|SUBHEADER\|PAGELENGTH\|PAGEWIDTH\|PAGE\|IF\|ELIF\|ELSE\|ENDIF\|INCLUDE\|BASE\|CYCLE_ADDR_ON\|CYCLE_ADDR_OFF\|HC12\|HCS12\|IFNOT\|MACROEND\|MACRO\|PAGE_CHECK\|SET\|SETNOT\)'
